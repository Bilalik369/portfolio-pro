...
const Home = () => {
  ...
  const buttonGradient = "from-red-600 to-red-800";
    ...
    <>
      <AnimatePresence>
        {!isLoaded && !hasAnimated && (
          ...
          >
            ...
            >
              <div className="w-24 h-24 border-t-4 border-red-500 border-solid rounded-full animate-spin mb-6 mx-auto"></div>
              <h2 className="text-2xl font-bold bg-gradient-to-r from-red-400 to-red-700 bg-clip-text text-transparent">
                Loading Portfolio
              </h2>
            </motion.div>
          </motion.div>
      ...
      >
        ...
        <div className="absolute inset-0 w-full h-full">
          ...
          />
          <div className="absolute top-20 left-10 w-72 h-72 bg-red-500/5 dark:bg-red-500/10 rounded-full filter blur-3xl transition-colors duration-500" />
          <div className="absolute bottom-20 right-10 w-72 h-72 bg-red-800/5 dark:bg-red-800/10 rounded-full filter blur-3xl transition-colors duration-500" />
        </div>
              ...
              <div className="relative">
                ...
                >
                  ...
                  <span className="relative inline-block">
                    <span
                      className="absolute inset-0 bg-gradient-to-r from-red-500 to-red-800 blur-xl opacity-30"
                    ...
                    <span
                      ...
                      style={{
                        background:
                          "linear-gradient(to right, #FF4D4D, #B30000)",
                ...
                >
                  ...
                  <span className="relative">
                    <span className="absolute -inset-1 bg-gradient-to-r from-red-500/20 to-red-800/20 blur rounded-lg"></span>
                    <TypeAnimation
                      sequence={[
                        "Developer",
                        2000,
                      ...
                      speed={50}
                      className="text-red-600 dark:text-red-400 font-semibold relative transition-colors duration-500"
                      wrapper="span"
                ...
                >
                  {services.map((service, index) => (
                    <div
                      key={index}
                      className="bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm border border-gray-200 dark:border-gray-700 rounded-xl p-3 text-center hover:border-red-500/50 transition-all duration-300 hover:transform hover:scale-105 shadow-sm hover:shadow-md"
                    >
                      <div
                ...
                <motion.div variants={fadeIn("up", 0.58)} className="mb-6">
                  <motion.p
                    ...
                    animate={{
                      ...
                      scale: 1,
                      textShadow: [
                        "0px 0px 0px rgba(179, 0, 0, 0)",
                        "0px 0px 12px rgba(179, 0, 0, 0.7)",
                        "0px 0px 0px rgba(179, 0, 0, 0)",
                      ],
                    }}
                    transition={{
                    ...
                    className="text-2xl font-bold bg-gradient-to-r from-red-400 via-red-600 to-red-800 bg-clip-text text-transparent"
                  >
