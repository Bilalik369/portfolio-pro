  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full">
        ...
        <div className="absolute top-20 left-10 w-64 h-64 bg-blue-500/5 dark:bg-blue-500/10 rounded-full filter blur-3xl" />
              ...
              <div className="flex gap-4">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    className="group relative w-14 h-14 rounded-xl flex items-center justify-center text-xl text-gray-600 dark:text-gray-300 overflow-hidden bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl border border-gray-200/50 dark:border-gray-700/50 hover:border-blue-500/50 transition-all duration-300"
                    whileHover={{ 
                      scale: 1.1, 
                      rotate: 5,
                      transition: { type: "spring", stiffness: 400, damping: 10 }
